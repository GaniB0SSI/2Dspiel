export const levelConfigs = {
	1: {
		...
		platforms: [
			...
			{ x: 700, y: 340, width: 180, height: 20, color: 0x8b4513 },
		...
		hazards: [{ x: 535, y: 320, width: 55, height: 18 }],
	...
	2: {
		...
		platforms: [
			...
			{ x: 550, y: 205, width: 130, height: 20, color: 0x7f5539 },
			{ x: 340, y: 145, width: 120, height: 20, color: 0x7f5539 },
			{ x: 165, y: 90, width: 110, height: 20, color: 0x7f5539 }
		],
		hazards: [
			{ x: 280, y: 520, width: 60, height: 18 },
			{ x: 440, y: 390, width: 60, height: 18 }
		],
